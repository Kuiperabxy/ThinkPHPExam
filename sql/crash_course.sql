...
--
-- Host: localhost    Database: crash_course
-- ------------------------------------------------------
...
--
-- Current Database: `crash_course`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `crash_course` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
--
-- Table structure for table `litchi`
--

DROP TABLE IF EXISTS `litchi`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `litchi` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `size` int(11) NOT NULL DEFAULT '0' COMMENT '颗粒大小',
  `taste` varchar(20) NOT NULL DEFAULT '' COMMENT '口感',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='荔枝测试表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `litchi`
--

LOCK TABLES `litchi` WRITE;
/*!40000 ALTER TABLE `litchi` DISABLE KEYS */;
INSERT INTO `litchi` VALUES (1,2,'PRETTY GOOD FOR ME !');
/*!40000 ALTER TABLE `litchi` ENABLE KEYS */;
UNLOCK TABLES;
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER newlitchi AFTER INSERT ON litchi
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER updatelitchi BEFORE UPDATE ON litchi
...
-- Dump completed on 2021-06-05 18:31:29
